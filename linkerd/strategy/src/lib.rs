...
//                     detect::Strategy::ClientData(_) => Detect::Client,
//                     detect::Strategy::Opaque(_) => Detect::Opaque,
//                 })
//             })
//             .unwrap_or(Detect::Client);

//         let target = target.and_then(Logical::new).unwrap_or_else(|| {
...
//                     unimplemented!()
//                 }
//                 api::concrete::Kind::Balance { authority } => unimplemented!(),
//             },

//             api::logical::Kind::Split(api::logical::Logical {
//                 metric_labels,
//                 inner,
//             }) => {
//                 let api::logical::logical::Inner::Split(split) = inner?;
