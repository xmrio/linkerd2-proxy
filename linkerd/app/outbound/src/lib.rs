        ...
        // P::Future: Send,
    {
        ...
        let serve = Box::pin(async move {
            ...
            let http_balancer = http_endpoint
                ...
                .push_on_response(
                    svc::layers().push(metrics.stack.layer(stack_labels("balance.endpoint"))), //             .box_http_request(),
                )
                .push_spawn_ready()
                .check_service::<Target<HttpEndpoint>>()
                //     .push(discover)
                ...
                .cache(
                    svc::layers().push_on_response(
                        svc::layers()
                            ...
                            // Shares the balancer, ensuring discovery errors
                            // are propagated. If the balancer has been ready &
                            // unused for `cache_max_idle_age`, fail the balancer.
            ...
            // XXX(eliza): make load balancer work.
            let http_concrete = http_forward_cache;
